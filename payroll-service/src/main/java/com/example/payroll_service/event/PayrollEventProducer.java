...
public class PayrollEventProducer {
    ...
    public void sendPayrollCreatedEvent(PayrollEventDto event) {
        try {
            ...
            rabbitTemplate.convertAndSend(payrollExchange, payrollCreatedRoutingKey, eventJson);
    ...
    public void sendPayrollProcessedEvent(PayrollEventDto event) {
        try {
            String eventJson = objectMapper.writeValueAsString(event);
            rabbitTemplate.convertAndSend(payrollExchange, payrollProcessedRoutingKey, eventJson);
    ...
    public void sendPayrollApprovedEvent(PayrollEventDto event) {
        try {
            String eventJson = objectMapper.writeValueAsString(event);
            rabbitTemplate.convertAndSend(payrollExchange, payrollApprovedRoutingKey, eventJson);
    ...
    public void sendPayrollCancelledEvent(PayrollEventDto event) {
        try {
            String eventJson = objectMapper.writeValueAsString(event);
            rabbitTemplate.convertAndSend(payrollExchange, payrollCancelledRoutingKey, eventJson);
    ...
    public void sendLoanPaymentEvent(PayrollEventDto event) {
        try {
            String eventJson = objectMapper.writeValueAsString(event);
            rabbitTemplate.convertAndSend(payrollExchange, loanPaymentRoutingKey, eventJson);
    ...
    public void sendSalaryComponentEvent(PayrollEventDto event) {
        try {
            String eventJson = objectMapper.writeValueAsString(event);
            rabbitTemplate.convertAndSend(payrollExchange, salaryComponentRoutingKey, eventJson);
