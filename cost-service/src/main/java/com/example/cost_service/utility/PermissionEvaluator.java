...
public class PermissionEvaluator {
    ...
    /**
     * Double check permission with additional validation (legacy method for backward compatibility)
     */
    private void doubleCheckPermission(String resource, String action, UUID tenantId, UUID resourceId) {
        checkPermission(resource, action, tenantId);
        ...
        log.debug("Double-check permission passed: {} {} for tenant: {}, resource: {}", 
                action, resource, tenantId, resourceId);
    }
